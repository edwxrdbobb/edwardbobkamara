    ...
    >
      ...
      <div className="flex flex-col pt-40 md:pt-0 select-none">
        ...
        <h1 className={`${styles.heroName} text-white text-6xl font-semibold`}>
          <span className={`relative ${styles.emphasize} seq`}>Edward</span>
          <span className="seq"> Bob-Kamara</span>
        </h1>
        <p>
          <span
            ref={typedEl}
      ...
      <div
        className="absolute invisible lg:visible w-8/12 lg:w-4/12 lg:bottom-1.5 md:bottom-12 lg:right-12 2xl:right-16"
        ref={lottieRef}
